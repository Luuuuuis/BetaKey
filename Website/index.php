'<html>
  <head>
    ...
    <script>
      ...
      $(window).ready(function () {
        ...
        history.pushState({}, '/BetaKeyV2', window.location.pathname);
      });
  ...
  <body>
    ...
    <!-- JavaScript -->
    <script>
      document.getElementById('closebutton').onclick = function(){ disappear() }

      function disappear() {
        document.getElementById('closebutton').parentElement.style.opacity = "0";
        setTimeout(function(){ document.getElementById('closebutton').parentElement.style.display = "none"; }, 600);
      }
    </script>
